...
namespace GtKanu.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260102215324_RmDataProt")]
    partial class RmDataProt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GtKanu.Infrastructure.Database.Entities.Booking", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Infrastructure.Database.Entities.Invoice", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Infrastructure.Database.Entities.InvoicePeriod", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Infrastructure.Database.Entities.Booking", b =>
                {
                    ...
                    b.HasOne("GtKanu.Infrastructure.Database.Entities.Invoice", "Invoice")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("GtKanu.Infrastructure.Database.Entities.Invoice", b =>
                {
                    b.HasOne("GtKanu.Infrastructure.Database.Entities.InvoicePeriod", "InvoicePeriod")
                        .WithMany("Invoices")
