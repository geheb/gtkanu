...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Boat", b =>
                {
                    b.Property<byte[]>("Id")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.BoatRental", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Booking", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.ClubhouseBooking", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.EmailQueue", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Food", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.FoodList", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityRoleClaimGuid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityRoleGuid", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityUserClaimGuid", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityUserGuid", b =>
                {
                    b.Property<byte[]>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityUserLoginGuid", b =>
                {
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityUserRoleGuid", b =>
                {
                    b.Property<byte[]>("UserId")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityUserTokenGuid", b =>
                {
                    b.Property<byte[]>("UserId")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Invoice", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.InvoicePeriod", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Mailing", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.MyMailing", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Trip", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.TripBooking", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.TripChat", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Tryout", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.TryoutBooking", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.TryoutChat", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Vehicle", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.VehicleBooking", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.WikiArticle", b =>
                {
                    b.Property<byte[]>("Id")
                        .HasColumnType("binary(16)");
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.BoatRental", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.Boat", "Boat")
                        .WithMany("BoatRentals")
                        .HasForeignKey("BoatId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("GtKanu.Core.Entities.IdentityUserGuid", "User")
                        .WithMany("BoatRentals")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Booking", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.Food", "Food")
                        .WithMany("Bookings")
                        .HasForeignKey("FoodId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("GtKanu.Core.Entities.Invoice", "Invoice")
                        .WithMany("Bookings")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Food", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.FoodList", "FoodList")
                        .WithMany("Foods")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityRoleClaimGuid", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.IdentityRoleGuid", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityUserClaimGuid", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.IdentityUserGuid", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.IdentityUserRoleGuid", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.IdentityRoleGuid", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.Invoice", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.InvoicePeriod", "InvoicePeriod")
                        .WithMany("Invoices")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.MyMailing", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.Mailing", "Mailing")
                        .WithMany("MyMailings")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.TripBooking", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.Trip", "Trip")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.TryoutBooking", b =>
                {
                    b.HasOne("GtKanu.Core.Entities.Tryout", "Tryout")
            ...
            modelBuilder.Entity("GtKanu.Core.Entities.VehicleBooking", b =>
                {
                    ...
                    b.HasOne("GtKanu.Core.Entities.Vehicle", "Vehicle")
                        .WithMany("Bookings")
