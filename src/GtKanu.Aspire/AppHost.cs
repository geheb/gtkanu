...
var sqliteDir = new DirectoryInfo("/data/gtkanu/sqlite");
if (!sqliteDir.Exists)
{
    sqliteDir.Create();
}

var mailpitDir = new DirectoryInfo("/data/gtkanu/mailpit");
if (!mailpitDir.Exists)
{
    mailpitDir.Create();
}

const string databaseFileName = "gtkanu.sqlite";
...
builder.AddProject<Projects.GtKanu_WebApp>("webapp")
